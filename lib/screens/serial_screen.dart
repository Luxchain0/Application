...
class SerialScreen extends StatefulWidget {
  static const String id = 'SerialScreen';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà. Questa è una descrizione lunga e noiosa che mai nessuno leggerà.', textAlign: TextAlign.justify,),
                ...
                Text('Le migliori quote in vendita: ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: heigh*0.02),),
                const Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    Expanded(
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          flex: 1,
          child: Text(numberOfQuotes.toString(), textAlign: TextAlign.center,)),
        Expanded(
          flex: 1,
          child: CustomButton(
            screenWidth: width,
